	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">Recommend Hotel</h2>
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="{{ route('home') }}">Home</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="{{ route('hotel') }}">Hotel</a>
					</li>
				</ul>
			</div>
		</div>
            ...
            @if ($categories->isNotEmpty())
                <ul class="list-unstyled widget-list d-flex flex-wrap justify-content-center gap-3">
                    ...
                    @foreach ($categories as $category)
                        <li>
                            <a wire:navigate 
                               href="{{ route('hotel') . '?categorySlug=' . $category->slug }}" 
                            ...
                            @foreach ($hotels as $hotel)
                                <div class="col-md-4" data-aos="fade">
                                    <article class="blog-post h-100">
                                        ...
                                        <div class="pt-4">
                                            <h2 class="h4">
                                                <a class="text-black" href="{{ route('hotelDetail', $hotel->id) }} ">
                                                    {{ $hotel->title }}
                                                </a>
                                            </h2>
                                            <p>{{ $hotel->short_desc }}</p>
                                            <a wire:navigate href="{{ route('hotelDetail', $hotel->id) }}" class="text-info fw-bold">Read More</a>
                                        </div>
                                    </article>
                                </div>
                            @endforeach
