							...
							<div class="contact-form">
								<form wire:submit="submit" >
									<div class="form-group mb-4 pb-2">
										...
										<input wire:model="name" type="text" class="form-control shadow-none @error('name') is-invalid @enderror"id="name" placeholder="Enter your name" name="name">
                                        @error('name')
									...
									<div class="form-group mb-4 pb-2">
										...
										<input wire:model="email" type="text" class="form-control shadow-none @error('email') is-invalid @enderror" id="email" placeholder="Enter your email" name="email">
                                        @error('email')
                                            <p class="invalid-feedback">{{ $message }}</p>
						...
						<div class="col-lg-6 col-12 mt-lg-0 mt-4">
							<div class="contact-info">
								...
								<div class="block mt-4">
									<h4 class="h1">Thank you for reaching out!</h1>
									<div class="content">
										<br>Kandal Province.
										<br>Mr. Seihak SE</div>
								</div>
